# Pollix - Guida Google Search Console & SEO
...
3. Scegli "URL prefix": `https://www.pollix.it`
...
3. Incolla: `https://www.pollix.it/sitemap.xml`
4. Clicca "Invia"
...
```bash
# Robots.txt
https://www.pollix.it/robots.txt

# Sitemap
https://www.pollix.it/sitemap.xml
...
2. Crea proprietà per `www.pollix.it`
